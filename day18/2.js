...
// Let the first few generations run until the pattern emerges
for (let i = 0; i < minutes; i++) {
  grid = makeNewGrid(grid)
}

let patternFound = false
let values = []

// find how many times the pattern repeats
while (!patternFound) {
  grid = makeNewGrid(grid)

  let value = countValue(grid)
...
console.log(values[((minuteToFind-minutes-1)%cycle)])
